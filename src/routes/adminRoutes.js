...
// Routes without auth/admin middleware
router.get('/live-requests', getLiveRequests);
router.get('/users', getUsers);
router.post('/users/:id/block', blockUser, audit('blockUser', req => req.params.id));
router.get('/wallet-requests', getWalletRequests);
router.post('/wallet-requests/:id/approve', approveWallet, audit('approveWallet', req => req.params.id));
router.post('/wallet-requests/:id/reject', rejectWallet, audit('rejectWallet', req => req.params.id));
